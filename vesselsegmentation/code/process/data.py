...
sys.path.append("..")
from code.dvn.utils import get_itk_array, make_itk_image, write_itk_image
...
def add_data_to_storage(data_storage, truth_storage, affine_storage, subject_data, affine, n_channels, truth_dtype):
    ...
    if n_channels<len(subject_data):
